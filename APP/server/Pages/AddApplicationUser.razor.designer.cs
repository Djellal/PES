...
namespace Pes.Pages
{
    public partial class AddApplicationUserComponent : ComponentBase, IDisposable
    {
        ...
        protected async System.Threading.Tasks.Task Load()
        {
            ...
            var dMdelGetDepartementsResult = await DMdel.GetDepartements();
        ...
        protected async System.Threading.Tasks.Task EtabdropdownChange(dynamic args)
        {
            var dMdelGetFacultesResult = await DMdel.GetFacultes(new Query() { Filter = $@"et=>et.Etabid == {args}" });
            getFacultesResult = dMdelGetFacultesResult;
        }
