...
namespace Pes.Pages
{
    public partial class StagiaireEvaluationsDetailComponent : ComponentBase, IDisposable
    {
        ...
        protected async System.Threading.Tasks.Task Load()
        {
            ...
            {
                NotificationService.Notify(new NotificationMessage(){ Severity = NotificationSeverity.Error, Summary = $"Attention", Detail = $"Aucune session active. Veuillez activer une session avant de consulter les évaluations." });
                return;
            }
